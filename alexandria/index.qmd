...
::: {layout-ncol=2}
![Home screen with reading progress and library access](images/home.png){fig-alt="Alexandria home screen showing currently reading card, reading statistics, and navigation to library, vocabulary, and settings"}

![Library with searchable author index and language filters](images/library.png){fig-alt="Alexandria library view showing Greek and Latin tabs, author list with work counts, and search bar"}
:::
...
::: {layout-ncol=2}
![Reading Aeschylus' Agamemnon in the original Greek](images/reader.png){fig-alt="Alexandria reader showing the Greek text of Aeschylus' Agamemnon with section numbers and line-by-line display"}

![Word lookup showing lemma, definition, and grammatical features](images/word-lookup.png){fig-alt="Alexandria word lookup popover showing the analysis of a Greek word with its lemma, English definition, and morphological features"}
:::
...
- **Multiple editions** — where available, compare different editions of the same work side by side
